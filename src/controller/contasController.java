...
public class contasController {
	...
	public void cadastrar() {
		...
		double eafcPointsValue = Double.parseDouble(EAFCpoints.getText());
		double coinsValue = Double.parseDouble(coins.getText());
		double expValue = Double.parseDouble(exp.getText());

		if (nickName.getText() == null || teamName.getText() == null || EAFCpoints.getText() == null
				|| coins.getText() == null || exp.getText() == null) {
			alert.setTitle("Invalido");
			alert.setContentText("Preencha todos os espaços!");
			alert.setHeaderText(null);
			alert.showAndWait();
		} else if (eafcPointsValue < 0) {
			alert.setTitle("Invalido");
			alert.setContentText("Valores de EAFC points negativos não são aceitos!");
			alert.setHeaderText(null);
			alert.showAndWait();
		} else if (coinsValue < 0) {
			alert.setTitle("Invalido");
			alert.setContentText("Valores de coins negativos não são aceitos!");
			alert.setHeaderText(null);
			alert.showAndWait();
		} else if (expValue < 0) {
			alert.setTitle("Invalido");
			alert.setContentText("Valores de EXP negativos não são aceitos!");
			alert.setHeaderText(null);
			alert.showAndWait();
		} else {
